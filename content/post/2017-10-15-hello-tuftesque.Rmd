...
_The readings below are suggested starting points if you are new to R or statistics in R. Feel free to skip if it would be review for you. _

# Getting Started

Welcome to R Fridays! To start, make sure that you have R and RStudio installed on your machine. 
...
The above should produce the following: `command R --version`
